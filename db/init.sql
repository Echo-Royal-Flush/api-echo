...
ALTER TABLE "feedback" ADD CONSTRAINT "feedback_id_evaluator_foreign" FOREIGN KEY ("id_evaluator") REFERENCES "user" ("id");
ALTER TABLE "user_team" ADD CONSTRAINT "user_team_id_team_foreign" FOREIGN KEY ("id_team") REFERENCES "team" ("id");
ALTER TABLE "feedback" ADD CONSTRAINT "feedback_id_card_foreign" FOREIGN KEY ("id_card") REFERENCES "card" ("id");
ALTER TABLE "user_team" ADD CONSTRAINT "user_team_id_user_foreign" FOREIGN KEY ("id_user") REFERENCES "user" ("id");
ALTER TABLE "user" ADD CONSTRAINT "user_id_company_foreign" FOREIGN KEY ("id_company") REFERENCES "company" ("id");
...
-- MOCK USERS
INSERT INTO "user" ("id", "name", "role", "position", "email", "password", "id_company") VALUES
  ('44444444-4444-4444-4444-444444444444', 'João Silva', 'ADMIN', 'Product Owner', 'joao@techcorp.com', '123456', '11111111-1111-1111-1111-111111111111'),
  ('55555555-5555-5555-5555-555555555555', 'Maria Souza', 'EMPLOYEE', 'Dev Backend', 'maria@techcorp.com', '123456', '11111111-1111-1111-1111-111111111111');

-- MOCK USER_TEAM
INSERT INTO "user_team" ("id", "id_user", "id_team") VALUES
...
INSERT INTO "feedback" ("id", "id_card", "id_evaluator", "id_evaluated", "description", "date", "is_anon", "type") VALUES
  ('aaaaaaa1-aaaa-aaaa-aaaa-aaaaaaaaaaa1', '88888888-8888-8888-8888-888888888888', '44444444-4444-4444-4444-444444444444', '55555555-5555-5555-5555-555555555555', 'Muito colaborativa no último sprint!', '2024-05-31', false, 'USER'),
  ('aaaaaaa2-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '99999999-9999-9999-9999-999999999999', '55555555-5555-5555-5555-555555555555', '44444444-4444-4444-4444-444444444444', 'Teve alguns atrasos nas entregas.', '2024-05-31', true, 'USER');
